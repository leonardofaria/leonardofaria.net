    ...
    details: [
      {
        ...
        period: '2023 — 2024',
        description:
          'Co-inventor on patent for compensation platform admin services. Developed scalable systems and intuitive UX for compensation review workflows, streamlining manager/director operations',
      },
    ],
  },
];
