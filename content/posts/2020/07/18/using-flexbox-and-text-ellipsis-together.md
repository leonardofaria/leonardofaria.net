...
<div className="filename">
  <span className="filename__base"
    >this-file-has-a-really-really-really-long-filename.</span
  >
...
<div className="full-width">
  <iframe src="https://codepen.io/leonardofaria/embed/rNxZJad" className="w-full h-screen" loading="lazy"></iframe>
</div>
