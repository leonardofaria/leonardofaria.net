...
Another way to hide red messages from your tests is the package [jest-mock-console](https://www.npmjs.com/package/jest-mock-console). This package can be an option for the approach mentioned in this post since you can control this at a test file level.
