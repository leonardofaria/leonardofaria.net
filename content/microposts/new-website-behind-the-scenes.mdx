...
publishedAt: 2023-04-12T21:40:00:00-08:00
template: post
type: Micropost
...
I started the work by porting my [Bento Hugo theme](https://bento-hugo-theme.netlify.app) to Next.js (or [TNT stack](https://twitter.com/rauchg/status/1641465057426165764): TypeScript, Next.js, and Tailwind CSS), changing some design elements when possible.
...
Since I'm using [Fira Code](https://github.com/tonsky/FiraCode) in my VS Code and iTerm and I enjoy fonts with ligatures, I added it here using [@next/font](https://nextjs.org/docs/api-reference/next/font). Doesn't know what are ligatures? Here is a sample:
...
I want to use this website as an experiment center for animations and parallaxes (is that the right plural?). I initially thought about using [AOS](https://michalsnik.github.io/aos/) (something similar to the old [wow.js](https://wowjs.uk) but I might just stick with [Framer Motion](https://www.framer.com/motion/). Parallax-wise, there are a few things with [react-scroll-parallax](https://npmjs.com/package/react-scroll-parallax), that I still want to improve.
